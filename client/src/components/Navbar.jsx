    ...
    >
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form className="form-inline my-2 my-lg-0">
          <button
            type="button"
            className="btn btn my-2 my-lg-0 mx-lg-1.5 text-light"
            style={{
              position: "relative",
          ...
          <button
            type="button"
            className="btn btn my-2 my-lg-0 mx-lg-1.5 text-dark"
            style={{
              position: "relative",
              fontSize: "15px",
              margin: "1px 0px",
